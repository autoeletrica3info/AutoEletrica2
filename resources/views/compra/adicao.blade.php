...
@stop
@section('form')
<form class="form-horizontal" method="POST" action="/cadastro/compra/produto">
{{csrf_field() }}
<fieldset>
...
<div class="row">
  ...
  <!-- Text inputText inputText inputText inputText inputText inputText inputText inputText-->
    ...
    <label class="col-md-8 control-label" for="produtos">Compras <h11>*</h11></label>  
  <div class="col-md-8">
    <select required  id="compra" name="compra" class="form-control">
