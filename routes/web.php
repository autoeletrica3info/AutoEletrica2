...
Route::get('/verificar/atendimento/{id}', 'atendimentoController@verificar');
...
Route::get('/excluir/compra/{id}', 'compraController@delete');
Route::delete('/compra/{id}', 'compraController@destroy');
Route::get('/verificar/compra/{id}', 'compraController@verificar');
